/*
    ...
    real business entities. The flyweight accepts the rest of the state (extrinsic state, unique for each entity) via
...
/*
    ...
    flyweights are shared correctly. When the client request a flyweight,
...
function addCarToPoliceDatabase(
    ff: FlyweightFactory, plates: string,
